...
import { calculateAccountCard } from "@/lib/reports/accountCard";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const data = await calculateAccountCard(membership.orgId, accountId, fromDate, toDate);
    return NextResponse.json(data);
  } catch (err: any) {
    console.error("ACCOUNT CARD API ERROR:", err);
