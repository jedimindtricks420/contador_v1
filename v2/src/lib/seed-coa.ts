...
export const MASTER_COA: CoaEntry[] = [
  ...
  { code: "9040", name: "Возврат проданных товаров (продукции)", type: "CONTRA_LIABILITY", group: "Доходы от осн. деятельности", layer: "EXTENSION", isDeprecated: false },
  ...
  { code: "9320", name: "Прибыль от выбытия прочих активов", type: "TRANSIT", group: "Прочие операц. доходы", layer: "EXTENSION", isDeprecated: false },
