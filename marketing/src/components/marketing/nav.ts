...
const LABELS: Record<Locale, Record<(typeof NAV_TOPIC_IDS)[number], string>> = {
  ru: { "02": "Возможности", "14": "Для бухгалтеров", "15": "Для руководителей", "26": "Инструменты", "17": "Тарифы" },
  uz: { "02": "Imkoniyatlar", "14": "Buxgalterlar uchun", "15": "Rahbarlar uchun", "26": "Vositalar", "17": "Tariflar" },
};
