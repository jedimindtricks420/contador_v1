...
const TRANSFER = [
  { what: "Банковские операции", how: "Поддерживаемым способом — импорт файла выписки (.txt, .xls, .xlsx) на первом шаге мастера закрытия" },
...
const STEPS = [
  ...
  { num: 3, title: "Подготовьте банковские выписки", desc: "В поддерживаемом формате .txt, .xls или .xlsx за периоды после даты начала." },
